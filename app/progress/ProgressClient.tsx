...
export default function ProgressClient({ totalConcepts }: ProgressClientProps) {
  ...
  return (
    <div style={{ maxWidth: "960px", margin: "0 auto", padding: "40px 24px" }}>
      ...
      {!loading && !user && (
        <div style={{ background: "rgba(249,115,22,0.1)", border: "1px solid rgba(249,115,22,0.3)", padding: "16px", borderRadius: "8px", marginBottom: "24px" }}>
          <h3 style={{ margin: "0 0 4px", fontSize: "1rem", color: "var(--accent-orange)" }}>Not signed in!</h3>
          <p style={{ margin: 0, fontSize: "0.85rem", color: "var(--text-secondary)" }}>Please sign in to view and save your progress.</p>
        </div>
      )}

      {/* Completion Celebrations */}
      {totalConcepts > 0 && stats.conceptsCompleted === totalConcepts && (
        <div style={{ background: "var(--gradient-green)", padding: "24px", borderRadius: "var(--radius-xl)", marginBottom: "32px", textAlign: "center", color: "#000" }}>
          <h2 style={{ fontSize: "2rem", fontWeight: "900", margin: "0 0 8px" }}>🎉 ALL LEVELS COMPLETED! 🎉</h2>
          <p style={{ margin: 0, fontWeight: "600" }}>You are a Python Master! You've completed every single concept and problem available.</p>
        </div>
      )}
